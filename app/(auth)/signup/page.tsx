...
export const Signup = () => {
  ...
  return (
    ...
    >
      <div
        className="w-[100%] h-[100%] bg-tertiary-dark rounded-l-none flex flex-col items-center justify-center text-white
                      sm:w-[50%] sm:rounded-l-[10px]"
      >
        <h1 className="text-3xl font-bold">Hello, Friend!</h1>
        <p className="m-4 text-center">
          If you are already a member? let's Login now
        </p>
        <button
      ...
      <div
        className="w-[100%] h-[100%] bg-white rounded-r-none flex flex-col items-center justify-center text-black 
      ...
      >
        ...
        >
          ...
          />
          <button
            className="border-2 border-white px-4 py-2 mb-2 rounded-[30px] mt-2 font-bold w-full bg-tertiary-dark text-white hover:opacity-80   disabled:pointer-events-none disabled:opacity-50"
            disabled={
